								...
								<tr>
									<td valign='top'>
										...
										$output .="	<select name='p_geb_monat'>";
														...
														$date_monat  = array("FEHLER","Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember");
										...
										$output .="	<input type='text' value='".$out_edit['p_geb_jahr']."' maxlength='4' size='4' name='p_geb_jahr'><span style='color:#ff0000;' class='small'></span>
											...
											<tr>
												...
												{
												$output .="<option selected value='M'>männlich</option>
...
$PAGE->render(utf8_decode(utf8_encode($output) )); // Ausgabe des gesamten Seiten inhaltes über das Dotlan-System
?>
